...
export class Redirect extends ethereum.Event {
  get params(): Redirect__Params {
    return new Redirect__Params(this);
  }
}

export class Redirect__Params {
  _event: Redirect;

  constructor(event: Redirect) {
    this._event = event;
  }
...
export class Pixels__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class Pixels extends ethereum.SmartContract {
  ...
  creatorRedirect(from: Address): Address {
    let result = super.call(
      "creatorRedirect",
      "creatorRedirect(address):(address)",
  ...
  try_creatorRedirect(from: Address): ethereum.CallResult<Address> {
  ...
  try_royaltyFraction(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "royaltyFraction",
      "royaltyFraction():(uint256)",
      []
  ...
  royaltyInfo(tokenId: BigInt, salePrice: BigInt): Pixels__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new Pixels__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    tokenId: BigInt,
    salePrice: BigInt
  ): ethereum.CallResult<Pixels__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Pixels__royaltyInfoResult(value[0].toAddress(), value[1].toBigInt())
    );
  }
  ...
  tokenExist(tokenId: BigInt): boolean {
    let result = super.call("tokenExist", "tokenExist(uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(tokenId)
    ]);
  ...
  try_tokenExist(tokenId: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall("tokenExist", "tokenExist(uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(tokenId)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class SetCreatorRedirectCall extends ethereum.Call {
  get inputs(): SetCreatorRedirectCall__Inputs {
    return new SetCreatorRedirectCall__Inputs(this);
  }

  get outputs(): SetCreatorRedirectCall__Outputs {
    return new SetCreatorRedirectCall__Outputs(this);
  }
}

export class SetCreatorRedirectCall__Inputs {
  _call: SetCreatorRedirectCall;

  constructor(call: SetCreatorRedirectCall) {
    this._call = call;
  }
...
export class SetCreatorRedirectCall__Outputs {
  _call: SetCreatorRedirectCall;
